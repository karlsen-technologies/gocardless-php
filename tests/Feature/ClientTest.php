...
it('can set and get the api client', function () {
...
it('can pass the credentials to the api client', function () {
    $credentials = new Credentials('valid', 'credentials');
...
it('can set and get the authentication tokens of the TokenClient', function () {
    $credentials = new Credentials('valid', 'credentials');
    $tokenClient = new TokenClient($credentials, 'https://example.com');
...
it('can get a list of banks from the api without a country', function () {
    $credentials = new Credentials('valid', 'credentials');
    $tokenClient = new TokenClient($credentials, 'https://example.com');
    $tokens = new Tokens('access', 10,  'refresh', 42);
...
it('can get a list of banks from the api with a country', function () {
    $credentials = new Credentials('valid', 'credentials');
    $tokenClient = new TokenClient($credentials, 'https://example.com');
    $tokens = new Tokens('access', 10,  'refresh', 42);
...
it('can get a bank from the api', function () {
    $credentials = new Credentials('valid', 'credentials');
    $tokenClient = new TokenClient($credentials, 'https://example.com');
    $tokens = new Tokens('access', 10,  'refresh', 42);
